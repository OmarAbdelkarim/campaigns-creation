...
export const NewCampaignModal: React.FC<NewCampaignModalProps> = ({
  ...
  const validateForm = (): boolean => {
    ...
    if (formData.enableAdvancedConcurrency) {
      if (!formData.groupName) {
        newErrors.groupName = 'Group selection is required when advanced concurrency is enabled';
      }
  ...
  const selectedGroup = GROUP_OPTIONS.find(group => group.id === formData.groupName);
                  ...
                  <label className="block text-sm font-medium text-gray-700 mb-2">
                    <div className="flex items-center">
                      ...
                      <div className="relative ml-2 group inline-block">
                        ...
                        <div className="invisible group-hover:visible absolute left-6 top-0 w-80 p-3 bg-gray-800 text-white text-xs rounded-lg shadow-lg z-[9999] pointer-events-none">
              ...
              <div className="bg-gray-50 rounded-lg border border-gray-200 p-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      type="checkbox"
                      checked={formData.enableAdvancedConcurrency}
                      onChange={(e) => setFormData(prev => ({ ...prev, enableAdvancedConcurrency: e.target.checked }))}
                ...
                {formData.enableAdvancedConcurrency && (
