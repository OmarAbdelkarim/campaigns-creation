...
import { X, Calendar, Clock, Phone, Globe, ChevronDown, ChevronUp, Info, Workflow, Users, ChevronRight } from 'lucide-react';
...
export const NewCampaignModal: React.FC<NewCampaignModalProps> = ({
  ...
  const validateForm = (): boolean => {
    ...
    // Validate advanced configuration fields if expanded
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl shadow-xl w-full max-w-4xl max-h-[90vh] overflow-hidden">
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <h2 className="text-heading-2">Campaign Info & Configurations</h2>
          <button
            onClick={onClose}
        ...
        <div className="overflow-y-auto max-h-[calc(90vh-140px)]">
          <form onSubmit={handleSubmit} className="p-6 space-y-8">
            ...
            {/* Advanced Configurations - Moved to the end */}
            <div className="space-y-6">
        ...
        <div className="bg-gray-50 px-6 py-4 border-t border-gray-200">
          <div className="flex items-center justify-between text-sm text-gray-600">
            <div className="flex items-center space-x-4">
              <span>Campaign Management System</span>
