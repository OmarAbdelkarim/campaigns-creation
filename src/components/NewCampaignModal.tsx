...
import { X, Calendar, Clock, Phone, Globe, ChevronDown, ChevronUp, Info, Workflow, ChevronLeft, ChevronRight } from 'lucide-react';
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl shadow-xl w-full max-w-4xl max-h-[90vh] overflow-hidden">
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <h2 className="text-heading-2">{getStepTitle()}</h2>
          <button
            onClick={onClose}
              ...
              <div className="space-y-8">
                ...
                <div className="bg-gray-50 rounded-lg border border-gray-200">
                  <button
                    ...
                    className="w-full px-6 py-4 flex items-center justify-between text-left hover:bg-gray-100 transition-colors duration-200 rounded-lg"
                  >
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <h3 className="text-sm font-medium text-gray-900">Advanced Configurations</h3>
                        <p className="text-xs text-gray-500">Configure concurrency and other advanced settings</p>
                      </div>
                    </div>
                    {isAdvancedOpen ? (
            ...
            {currentStep === 3 && (
              <div className="space-y-6">
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
                  <h3 className="text-lg font-medium text-blue-900 mb-4">Campaign Summary</h3>
                  
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-4">
                      <div>
                        <label className="text-sm font-medium text-blue-700">Campaign Name</label>
                        <p className="text-blue-900 font-medium">{formData.name || '—'}</p>
                      </div>
                      ...
                      <div>
                        <label className="text-sm font-medium text-blue-700">IVR</label>
                        <p className="text-blue-900 font-medium">{formData.ivr || '—'}</p>
                      </div>
                    ...
                    <div className="space-y-4">
                      <div>
                        <label className="text-sm font-medium text-blue-700">Timezone</label>
                        <p className="text-blue-900 font-medium">
                      ...
                      <div>
                        <label className="text-sm font-medium text-blue-700">Maximum Tries</label>
                        <p className="text-blue-900 font-medium">{formData.maxTries}</p>
                      </div>
                      
                      <div>
                        <label className="text-sm font-medium text-blue-700">Retry Interval</label>
                        <p className="text-blue-900 font-medium">{formData.retryInterval}</p>
                      </div>
                      
                      <div>
                        <label className="text-sm font-medium text-blue-700">Concurrency</label>
                        <p className="text-blue-900 font-medium">{formData.concurrency}</p>
                      </div>
                    </div>
                  </div>
                  
                  <div className="mt-6">
                    <label className="text-sm font-medium text-blue-700">Active Days</label>
                    <div className="flex flex-wrap gap-2 mt-2">
                      {WEEKDAYS.filter(day => formData.schedule[day.key].enabled).map(day => (
                        <span key={day.key} className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                          {day.short}: {formatTo12Hour(formData.schedule[day.key].startTime)} - {formatTo12Hour(formData.schedule[day.key].endTime)}
                        </span>
                      ))}
                    </div>
                  </div>
