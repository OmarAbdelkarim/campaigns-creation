...
import { X, Calendar, Clock, Phone, Globe, ChevronDown, ChevronUp, Info, Workflow, ChevronRight, ChevronLeft } from 'lucide-react';
      ...
      <div className="bg-white rounded-xl shadow-xl w-full max-w-4xl max-h-[90vh] overflow-hidden">
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div>
            ...
            <p className="text-sm text-gray-600 mt-1">{getStepName()}</p>
          </div>
          <button
            onClick={onClose}
          ...
          <form onSubmit={handleSubmit} className="p-6">
            ...
            {currentStep === 2 && (
              <div className="space-y-8">
                ...
                {/* Advanced Configurations - Now positioned here */}
                  ...
                  >
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500">Configure retry attempts, timing, and concurrency settings</p>
                      </div>
                    </div>
                    {isAdvancedOpen ? (
              ...
              <div className="space-y-6">
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h3 className="font-medium text-blue-900 mb-1">Ready to Create Campaign</h3>
                      <p className="text-sm text-blue-700">
                        Please review your campaign settings below. Once created, you'll be able to import your audience list and start making calls.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-4">
                      ...
                      <div className="space-y-3">
                        ...
                        <div>
                          <label className="text-sm font-medium text-gray-500">Outbound Caller ID</label>
                          <div className="flex items-center">
                            <span className="text-lg mr-2">{selectedPhoneNumber?.flag}</span>
                            <span className="text-base text-gray-900 font-mono">{selectedPhoneNumber?.formatted}</span>
                          </div>
                        </div>
                        <div>
                          <label className="text-sm font-medium text-gray-500">IVR</label>
                          <p className="text-base text-gray-900 font-mono">{formData.ivr}</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-3">
                        ...
                        <div>
                          ...
                          <p className="text-base text-gray-900">
                            {formData.endDate ? new Date(formData.endDate + 'T00:00:00').toLocaleDateString('en-US', {
                              weekday: 'long',
                              year: 'numeric',
                              month: 'long',
                              day: 'numeric'
                        ...
                        {WEEKDAYS.map(day => (
                          <div key={day.key} className={`flex items-center justify-between p-3 rounded-lg ${
                            ...
                            <span className={`text-sm font-medium ${
                              formData.schedule[day.key].enabled ? 'text-green-900' : 'text-gray-500'
                            }`}>
                              {day.short}
                            </span>
                            {formData.schedule[day.key].enabled ? (
                              <span className="text-xs text-green-700 font-mono">
                                {formatTo12Hour(formData.schedule[day.key].startTime)} - {formatTo12Hour(formData.schedule[day.key].endTime)}
                              </span>
                            ) : (
                    ...
                    <div className="bg-gray-50 rounded-lg p-4">
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                          ...
                          <p className="text-base text-gray-900">{formData.maxTries}</p>
                        </div>
                        <div>
                          <label className="text-sm font-medium text-gray-500">Retry Interval</label>
                          <p className="text-base text-gray-900 font-mono">{formData.retryInterval}</p>
                        </div>
                        <div>
                          <label className="text-sm font-medium text-gray-500">Concurrency</label>
                          <p className="text-base text-gray-900">{formData.concurrency}</p>
                        </div>
                      </div>
                    </div>
                  </div>
